...
CONSTRAINT FK_transfer_sender_user FOREIGN KEY (account_from) REFERENCES tenmo_user(username),
    CONSTRAINT FK_transfer_recipient_user FOREIGN KEY (account_to) REFERENCES tenmo_user(username)
);
...
INSERT INTO transfer ( account_from, amount, account_to)
VALUES ('bob', 50.00, 'user'),
       ('user', 37.25, 'bob');
